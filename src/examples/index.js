(async () => {
    let module = await import("../../dist/examples/TestController.js")
    try {
        await module.testQuery({
    ...
    // });
    //
    // require("../../dist/examples/ClassControllerExample").echo({
    //     body: "{\"hello\": \"world!\"}",
    ...
    // });
    //
    // require("../../dist/examples/ClassControllerExample").preAndPostMiddleware({
    //     body: "{\"hello\": \"world!\"}",
    //     headers: {"Content-Type": "application/json"}
    // }, {}, (err, res) => {
    ...
    // });
    //
    // require("../../dist/examples/TestErrorController").echo({
    //     body: {name: "test", age: "24.25"},
    //     headers: {"Content-Type": "application/json"}
    // }, {}, (err, res) => {
    //     console.log("TestController.echo", err, res);
    // });
    //
    // require("../../dist/examples/TestErrorController").error({
    //     body: {name: "test", age: "24.25"},
    //     headers: {"Content-Type": "application/json"}
    // }, {}, (err, res) => {
    //     console.log("TestController.error", err, res);
    // });
    // require("../../dist/examples/AnnotationClassControllerExample").echo({
    //     body: JSON.stringify({
    //         name: "test",
    //         age: "24.25"
    //     }), headers: {"Content-Type": "application/json"}
    ...
    // });
    //
    // require("../../dist/examples/AnnotationClassControllerExample").preAndPostMiddleware({
    //     body: JSON.stringify({
    //         name: "test",
    //         age: "24.25"
    //     }), headers: {"Content-Type": "application/json"}
